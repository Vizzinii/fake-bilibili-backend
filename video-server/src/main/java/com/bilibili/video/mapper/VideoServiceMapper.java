...
public interface VideoServiceMapper {
    ...
    List<CommentDetailVO> getCommentToVideo(Integer videoId);
    ...
    List<CommentDetailVO> getCommentToComment(Integer videoId);
    ...
    List<CollectVideoVO> getCollectVideo(Integer collectGroupId);
    ...
    List<FirstPageVideoVO> getFirstPageVideo(Integer count);
    ...
    List<HistoryVideoVO> getHistoryVideo(Integer userId);
}
