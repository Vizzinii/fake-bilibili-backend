package com.bilibili.notice.mapper;
...
public interface NoticeServiceMapper {
    ...
    List<LikeNoticeVO> getVideoLikeNotice(Integer userId);
    ...
    List<LikeNoticeVO> getCommentLikeNotice(Integer userId);
    ...
    List<CommentNoticeVO> getCommentToVideoNotice(Integer userId);
    ...
    List<CommentNoticeVO> getCommentToCommentNotice(Integer userId);
    ...
    List<DynamicVideoVO> getDynamicVideoNotice(Integer userId);
}
